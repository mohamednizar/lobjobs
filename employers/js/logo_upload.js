jQuery(document).ready(function($){
	...
	$(".IMU").each(function(index){
		...
		if(typeof(self.attr("startOn"))!="undefined")
		{
			...
			{
				self.after("<input type='image' value='" + (typeof(self.attr("buttonCaption"))=="undefined" ? '':self.attr("buttonCaption")) + "' id='IMU"+index+"start' class='uploadButton'  />");
		...
		var buttonImg = "";
		if(typeof(self.attr("image"))!="undefined")
			buttonImg = self.attr("image");
		var bwidth = 120;
		...
		var uploadScript = "upload_logo.php";
