...
<br><br><br>
                    ...
                    <br>
                     <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="emlphn" id="emlphn" placeholder="Email & Phone" required="true" value="<?php echo $cname ?>">
                    </div>
                    <br>
                    ...
                    <div class="form-group">
                       <a id="job_create" class="btn btn-primary " style="position:relative" >submit</a>
                    </div>
		...
		var Jobtype = $('.selectjobtype').val();//jobtype
                ...
                $.ajax({
                    ...
                    success: function (data) {
                                    alert('Job Created')
                                    window.location.href="http://lobjobs.lk/employers/jobsubmit.php?id="+userid;;
