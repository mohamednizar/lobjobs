...
<input type="number" id="searchid" class="input-sm" placeholder="Serch by ID"><button value="searchby" id="searchby" class="input-sm btn btn-success ">Search</button>
      ...
      <tbody id="search_body">
		...
		if (isset($_GET['app'])){
			...
			$empty_al = strlen ($al_info);
					...
					$id= $info['id'];
					$org = $info['org'];
					$href="cv_gen.php?id=" . $id . "&org=".$org;
					$href_back="jobseeker_cv.php?app=back&id=" . $id . "&org=".$org;
					$href_delete="cv_gen.php?app=delete&id=" . $id . "&org=".$org;
					?>
