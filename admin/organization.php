<?php include 'header.php';?>
	...
	<div class="col-md-4">
	  ...
	  <div class="col-md-6">
	   <span class="contact_org">Contact - 0114 347 001 &nbsp; &nbsp; Email - <a href="mailto:info@lobjobs.lk" target="_top">info@lobjobs.lk</a></span>
        ...
        <button class="btn btn-success btn-lg" id="email" role="button">Send Email</button>
    ...
    width: 111px;'><span class='glyphicon glyphicon-send iconfont'></span>";
                    ...
                    <td><a target="_blank" href="<?php echo $href ?>">View</a></td></tr>
                </tr>
                <?php
            }
            ?>
  ...
  $(".area_box_live").hide();
   $("#toogle_level").hide();
        ...
        $('#email').click(function() {
           var email = "";
            $(".seeker").find('tr').each(function(i){
            var $tds = $(this).find('td.seeker_email');
            e = $tds.text();
            var vn =0
            email =email + e +",";
            vn = vn +1;
         //  alert(e+'Email No'+vn);
         // window.location.href = "mailto:?bcc="+email;
            })
            console.log(email);
             window.location.href = "mailto:?bcc="+email;
            });
