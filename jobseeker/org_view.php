...
$back_link ='org_info.php';
			...
			while($info = mysqli_fetch_array( $data )) {
				$basic_info= ($info['basic_info']);
					...
					if (!isset($_GET['org'])){
					?>
					<a href="admin.php" type="button" class="btn btn-primary btn-lg">New Organization</a>
					<a href="admin.php?id=active" type="button" class="btn btn-default btn-lg">Approved Organization</a>
					<?php		
					}
					?>
					...
					<div class="row">
					<div class="col-md-2">
					<img src="<?php echo "files/".$info['logo']?>" alt="..." class="img-thumbnail" width="100px" height="100px">
					</div>
			...
			<?php 
				...
				$.ajax({
								...
								//window.location.href = $link;
                                    ...
                                    <a class='btn jobsubmit' href='<?php echo $back_link ?>' >Back</a>
