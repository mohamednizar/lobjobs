<div><a href="logout.php"  type="button" class="btn btn-default btn-lg">logout</a></div>
<div class="container">
    <style>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <span >
                        <div class="col-md-2">
                            ...
                            <?php if ($info['pic_info'] == null) {
                                ?>
                                <img src="files/profile.png" alt="..." class="img-thumbnail" width="100px" height="100px">
                    ...
                    <div class="" style="position:absolute;left:60%;top:30%" >
                        ...
                        <br>
                        <div style="position:relative;left:75%;top:40%" >
                         <input class="IMU" type="file" path="files/" multi="true"  startOn="auto" afterUpload="none" maxSize="2000800" allowRemove="true" sessionId="<?php echo $_GET['id']; ?>" />
                         </div>
                         </div>
...
FROM vacancies INNER JOIN seeker_vacant ON vacancies.id = seeker_vacant.vacant_id WHERE seeker_id ='$id'";
                            ...
                            <div class="container">
                                ...
                                <div class="col-md-9 container " id="hidethis_area" style="display:none; "  >
                                    ...
                                    <div class="form-group more_space">
                                        ...
                                        <button class="btn btn-lg" id="update_info" role="button">save</button>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="col-md-12" id="hidethis_ol" style="display:none">
                ...
                <a class="btn btn-default" id="updata_ol" role="button">update</a>
            </div>
...
<div class="row" >
        ...
        <div class="col-md-12" id="hidethis_al" style="display:none">
            ...
            <a class="btn btn-default" id="updata_al" role="button">update</a>
        </div>
        </div>
<div class="row" >
        <div class="container">
        ...
        <div class="row" >
            ...
            <div>
                <div class="row">
                    <div class="col-md-12"  class="col-md-12" id="hidethis_pro" style="display:none" >
                        <form class="form-inline" role="form">
                            <div class="form-group">
                        ...
                        <a class="btn btn-default" id="updata_pro" role="button">update</a>
                    </div>
                </div><!-- end of row-->
        ...
        <div class="container">
            ...
            while ($info = mysqli_fetch_array($data)) {
                ...
                <div id="hidethis_lang" style="display:none" >
                    <a class="btn btn-default" id="updata_lang" role="button">update</a>
                </div>
         ...
         <div class="row">
            ...
            <div class="col-md-12"  class="col-md-12" id="hidethis_com" style="display:none">
                <form class="form-inline" role="form">
                    ...
                    <a class="btn btn-default" id="updata_com" role="button">update</a>
                </form>    
            </div>
            </div>
                </div>
            ...
            <div class="row">
                ...
                <div id="hidethis_work" style="display:none">
                    ...
                    <a class="btn btn-default" id="updata_work" role="button">update</a>
                </div>
            </div>
            </div>
             ...
             <div class="container col-md-12">
                ...
                <div class="col-md-12 extra_margin">
                    ...
                    <tbody class="col-md-12 " >
                        ...
                        while ($info = mysqli_fetch_array($data)) {
                            ...
                            $array3 = explode(',', $string);
                             echo "<tr><td  class ='col-md-4'>". $string  ."</tr></td>";
                ...
                <div class="container ">
                    <div class="col-md-4" id="hidethis_sub" style="position: relative;display:none ;">

                        <table class="table col-md-4 col-xs-1 city table-bordered" >
                            <thead>
                            <thead class="">
                                <tr>
                                    <th class="">Click on your Suburbs knowledge Cities</th>
                                </tr>
                            </thead>
                            ...
                            <tbody class="col-md-6 ">
                                ...
                                <tr><td>
                                        <a class="btn btn-default" id="updata_sub" role="button">update</a>
                                    </td></tr>
            ...
            <div class="row">
                ...
                <table id="city_table" class="table col-md-4 table-hover">
                    <thead>
                        <tr>
                ...
                <div class="container " id="hidethis_drive" style="display: none;width:50%;top:-100px;right: -100px">
                    <table class="table Driving col-md-4  table-bordered">
                        <thead class="">
                            <tr>
                                <th class="">Click on your Driving Licences</th>
                            </tr>
                        </thead>									
                        ...
                        <tbody class="col-md-2">
                            <tr>
                                ...
                                <td name="G" >G</td>
                                <td name="J" >J</td>
                                <td> <a class="btn btn-default" id="updata_drive" role="button">update</a></td>
                            </tr>
