...
<html lang="en">
                ...
                <div class="navbar navbar-default navbar-static-top" role="navigation">
                    <div class="container">
                        ...
                        if ($html_name == "organization.php") {
                            ...
                            <a type="button" href="jobseeker/signin.php?cat=org" class="col-xs-12 btn btn-success">Sign in</a>
    ...
    <br><br><br><br><br>
    <h1>Your password reset link sent to your email</h1>
    <h4>Please check you email and click the link to reset your password</h4>
    <p>*If you are not recive the email at the movement,Please check your email after few minutes<p>
</html>