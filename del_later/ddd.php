	...
	<div class="row">
		<div class="col-md-12">
			...
			<option selected="selected">Year</option>
			  ...
			  <div class="form-group">
				<label for="inputEmail3" class="col-sm-2 control-label">Married Status</label>
				<div class="col-sm-4">
				<select class="multiselect"  >
				...
				<div class="col-sm-4">
				<select class="multiselect"  >
				<option value="male">Sinhala</option>
			...
			<div class="form-group">
				<label for="inputEmail3" class="col-sm-2 control-label">Permanent living place</label>
				<div class="col-sm-4">
				<select class="multiselect" >
				...
				<div class="form-group">
				<label for="inputEmail3" class="col-sm-2 control-label">Current living place</label>
				<div class="col-sm-4">
				<select class="multiselect" >
				<option value="Vavuniya">Vavuniya</option>
				<option value="Trincomalee">Trincomalee</option>
